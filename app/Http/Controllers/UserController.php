...
class UserController extends Controller
{
    ...
    public function userAllData(){
        ...
        //return needed data
        return $this->ApiResponse(["username"=>$user->first_name,"name"=>$user->last_name,"userEmail"=>$user->email,"currentPassword"=>null,"newPassword"=>null,"confirmPassword"=>null,'img' => $user->img? asset('storage/' . $user->img): asset('images/default-user.png'),],"User data returned Succesfully!",200);
    }
